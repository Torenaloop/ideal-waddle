...
- Jesse - what material, files, etc. to be successful 
- 8/23 week of is proposed
	- Jesse - don't share protocol ahead of time 

Audit questions

Let same

Changed color matrix

Has questions about providing recommendations 

Can export the spreadsheet data into whatever tool we need

Added definitions of finding categorizations/ratings

David to converse with Goetz and Sauce

David to ping Taylor Muvrin - re: NetSuite 
