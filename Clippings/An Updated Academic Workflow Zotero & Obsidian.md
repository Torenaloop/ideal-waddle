...
created: 2025-09-29
description: "An Updated Academic Workflow: Zotero & Obsidian August 2023 Last year, I wrote the post An Academic Workflow: Zotero & Obsidian setting out how I use both programs as part of my work as an academic …"
tags:
  - "clippings"
---
...
![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*z4erm4ShPpbDhYS7WDRWbw.png)
...
![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*B08ORIPGPYHF9qmWQwNFsg.png)
...
![](https://miro.medium.com/v2/resize:fit:640/format:webp/0*yRAPt99dHz_9xZYs.jpeg)
...
![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*zMig5i6Tpymm9TNiyY8agw.png)
...
![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*8ZL5QCM6CERgl17sQmTKtQ.png)
...
![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*MO3_JBleGvNCFhMGAxhp0g.png)
...
![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*MQ6AbPHDk27mR8a0IkT0BQ.png)
...
![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*xdTUSbJTR_7AqQ2xn1lgpA.png)
...
\`\`\`
```
![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*ybNaMP6HJ4cZwhq5mUsiaw.png)
...
![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*3UAWW35ZmDQeezpmJh2fTg.png)
...
![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*fXdtpONnlVzWqUEogZ1OLQ.png)
...
![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*DLTnf4f_6ZMKISITj-VVwA.png)
...
![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*IdtJc0K6cVCFOMxTMyrJQA.png)

Screenshot of Obsidian command prompt for Zotero Integration

You can then select the relevant citation in Zotero…

![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*DnVbUU5di2ywZxPpRbTbKw.png)

Screenshot of Zotero command prompt

and the selected cite is inserted into the document.

![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*sXzRP2DibCGdaDHwNriY9Q.png)

Screenshot of citation inserted in pandoc style while selected.

![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*3hnCdIz5qZAYJr-yk_924w.png)
...
![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*6wRezcjZFRwxuhX2VXdvpg.png)
...
Write a response[What are your thoughts?](https://medium.com/m/signin?operation=register&redirect=https%3A%2F%2Fmedium.com%2F%40alexandraphelan%2Fan-updated-academic-workflow-zotero-obsidian-cffef080addd&source=---post_responses--cffef080addd---------------------respond_sidebar------------------)

```ts
Hi Alexandra,Thank you for this sharing. Your workflow is just amazing ! I've applied your way of working, and I combine it with the workflow of Leonardo Castorina (https://betterhumans.pub/obsidian-tutorial-for-academic-writing-87b038060522). This…
```

17

```ts
I found myself coming back to this article multiple times. I watched many videos and read many articles but this right here resonates with me the most.Thank you for making this resource freely accessible to all! <3
```

10

```ts
For anyone new to Obsidian & running into a "parsing template" error: try copying the template into a plain text word editor, like Notepad, and then copying from Notepad into you Literature Notes template on Obsidian. The create literature note command should work after that.
```

14

## More from Alexandra Phelan
...
](https://medium.com/?source=post_page---read_next_recirc--cffef080addd---------------------------------------)